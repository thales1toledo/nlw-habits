  ...
  return (
    <div className='w-full max-w-3xl mx-auto flex items-center justify-between'>
      ...
      <Dialog.Root>
        <Dialog.Trigger
          type='button'
          className='rounded-lg border border-violet-500 font-semibold px-6 py-4 flex items-center gap-3 hover:border-violet-300 transition-colors focus:outline-none focus:ring-2 focus:ring-violet-600 focus:ring-offset-2 focus:ring-offset-background'
        >
